...
export default async function SchedulingPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-2">Scheduling & Availability</h1>
        <p className="text-zinc-500 dark:text-gray-400">Field technician availability, time slots, vacation, dispatch integration.</p>
      </div>
      <SchedulingContent
