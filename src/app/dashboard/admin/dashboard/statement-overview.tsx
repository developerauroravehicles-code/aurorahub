    ...
    <div className="bg-white/5 border border-gray-800 rounded-lg p-6">
      ...
      <div className="space-y-3">
        <div className="p-3 rounded-lg border border-gray-700 bg-black/20">
          <p className="text-sm text-gray-400">Dealers with completed demands (last 30 days)</p>
          <p className="text-2xl font-bold text-white">{dealersWithRecentCompleted}</p>
        </div>
        <div className="p-3 rounded-lg border border-gray-700 bg-black/20">
          <p className="text-sm text-gray-400">Completed demands (last 30 days)</p>
