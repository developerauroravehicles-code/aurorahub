  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-2">Sales Reports</h1>
          <p className="text-zinc-500 dark:text-gray-400">View detailed reports of your demands and appointments</p>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="bg-zinc-200/50 dark:bg-white/5 border border-zinc-200 dark:border-gray-800 p-6 rounded-lg">
            ...
            {demands.length === 0 ? (
              <p className="text-zinc-500 dark:text-gray-400 text-center py-8">No demands found for the selected date range.</p>
            ) : (
