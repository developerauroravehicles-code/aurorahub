...
export default function FinanceReportsPage() {
  ...
  const fetchDemands = async () => {
    ...
    try {
      ...
      // Fetch demands assigned to this finance user
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-2">Finance Reports</h1>
          <p className="text-zinc-500 dark:text-gray-400">View detailed reports of your assigned demands and appointments</p>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-zinc-200/50 dark:bg-white/5 border border-zinc-200 dark:border-gray-800 p-6 rounded-lg">
              <h3 className="text-sm font-medium text-zinc-500 dark:text-gray-400 mb-2">Total Assigned Demands</h3>
          ...
          <div className="bg-zinc-200/50 dark:bg-white/5 border border-zinc-200 dark:border-gray-800 p-6 rounded-lg">
            ...
            {demands.length === 0 ? (
              <p className="text-zinc-500 dark:text-gray-400 text-center py-8">No assigned demands found for the selected date range.</p>
            ) : (
