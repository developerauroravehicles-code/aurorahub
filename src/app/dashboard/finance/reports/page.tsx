      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/5 border border-gray-800 p-6 rounded-lg">
              <h3 className="text-sm font-medium text-gray-400 mb-2">Total Assigned Demands</h3>
          ...
          <div className="bg-white/5 border border-gray-800 p-6 rounded-lg">
            ...
            {demands.length === 0 ? (
              <p className="text-gray-400 text-center py-8">No assigned demands found for the selected date range.</p>
            ) : (
