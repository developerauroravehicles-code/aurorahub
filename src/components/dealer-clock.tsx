...
export function DealerClock({ timezoneName, timezoneDisplayName }: DealerClockProps) {
  ...
  if (!mounted) {
    return (
      <div className="flex min-w-0 w-full max-w-full flex-col gap-0.5 text-sm bg-white/90 dark:bg-black/80 backdrop-blur-sm border border-[#C27E00]/40 rounded-lg px-3 py-3 shadow-lg sm:px-4">
